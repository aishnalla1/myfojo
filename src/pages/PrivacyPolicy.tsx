...
<div className="w-full">
  <section className="py-20 bg-background">
    <div className="container mx-auto px-6">
          ...
          <div className="px-4 py-8 max-w-5xl mx-auto  whitespace-pre-wrap  text-justify font-lato">
            <p>
Foomill Private Limited (Formerly known brand name as MYFOJO) and/ or its affiliates ("Foomill," the "Company," "we," "us," and "our,") respect your privacy and is committed to protecting it through its compliance with its privacy policies.
This policy describes:<br />
●	The types of information that MYFOJO may collect from you when you access or use its websites, applications and other online services (collectively, referred as "Services"); and<br />
●	Its practices for collecting, using, maintaining, protecting and disclosing that information.<br />
  This policy applies only to the information MYFOJO collects through its Services, in email, text and other electronic communications sent through or in connection with its Services.<br />
This policy DOES NOT apply to information that you provide to, or that is collected by, any third-party, such as restaurants at which you make reservations and/or pay through MYFOJO Services and social networks that you use in connection with its Services. MYFOJO encourages you to consult directly with such third-parties about their privacy practices.<br />
Please read this policy carefully to understand MYFOJO policies and practices regarding your information and how MYFOJO will treat it. By accessing or using its Services and/or registering for an account with MYFOJO, you agree to this privacy policy and you are consenting to MYFOJO collection, use, disclosure, retention, and protection of your personal information as described here. If you do not provide the information MYFOJO requires, MYFOJO may not be able to provide all of its Services to you.<br />
If you reside in any other part of the world, Foomill Private Limited (MYFOJO), located at 1350, Sector-28, Faridabad - 121008, Haryana, India will be the controller of your personal data provided to, or collected by or for, or processed in connection with our Services.<br />
  Your data controller is responsible for the collection, use, disclosure, retention, and protection of your personal information in accordance with its privacy standards as well as any applicable national laws. Your data controller may transfer data to other members of MYFOJO as described in this Privacy Policy. MYFOJO may process and retain your personal information on its servers in India where its data centers are located, and/or on the servers of its third parties (in or outside India), having contractual relationships with MYFOJO.
This policy may change from time to time, your continued use of MYFOJO Services after it makes any change is deemed to be acceptance of those changes, so please check the policy periodically for updates.
</p><br />

<h1 className="font-lato font-bold text-center text-2xl mb-4">The information we collect and how we use it</h1>
<p>
Foomill Private Limited ("MYFOJO," the "Company," "we," "us," and "our”) collects several types of information from and about users of our Services, including:<br />
●	Your Personal Information("PI") - Personal Information is the information that can be associated with a specific person and could be used to identify that specific person whether from that data, or from the data and other information that we have, or is likely to have access to. We do not consider personal information to include information that has been made anonymous or aggregated so that it can no longer be used to identify a specific person, whether in combination with other information or otherwise.<br />
●	Information about your internet connection, the equipment you use to access our Services and your usage details.<br />

We collect this information:<br />
●	Directly from you when you provide it to us; and/or<br />
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">Information You Provide to Us</h1>
<p>
The information we collect on or through our Services may include:<br />
...
●	Your preferences: Your preferences and settings such as time zone and language.<br />
●	Your searches and other activities: The search terms you have looked up and results you selected.<br />
●	Your browsing information: How long you used our Services and which features you used; the ads you clicked on.<br />
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">Information about Your Friends</h1>
<p>
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">Information about Your Messages</h1>
<p>
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">Information We Collect Through Automatic Data Collection Technologies</h1>
<p>
We may automatically collect certain information about the computer or devices (including mobile devices) you use to access the Services, and about your use of the Services, even if you use the Services without registering or logging in.<br />
●	Usage information: Details of your use of our Services, including traffic data, location data, logs and other communication data and the resources that you access and use on or through our Services.<br />
●	Computer and device information: Information about your computer, Internet connection and mobile device, including your IP address, operating systems, platforms, browser type, other browsing information (connection, speed, connection type etc.), device type, device's unique device identifier, mobile network information and the device's telephone number.<br />
●	Mobile device IDs: Unique mobile device identifier (e.g. IDFA or other device IDs on Apple devices like the iPhone and iPad), if you're using our Services on a mobile device, we may use mobile device IDs (the unique identifier assigned to a device by the manufacturer), instead of cookies, to recognize you. We may do this to store your preferences and track your use of our applications. Unlike cookies, mobile device IDs cannot be deleted. Advertising companies may use device IDs to track your use of our applications, track the number of advertisements displayed, measure advertising performance and display advertisements that are more relevant to you. Analytics companies may use mobile device IDs to track your usage of our applications.<br />
●	Stored information and files: Our applications also may access metadata and other information associated with other files stored on your mobile device. This may include, for example, photographs, audio and video clips, personal contacts and address book information.<br />
●	Location information: Our applications collect real-time information about the location of your device, as permitted by you.<br />
●	Last URL visited: The URL of the last web page you visited before visiting our websites.<br />
●	Your preferences: Your preferences and settings such as time zone and language.<br />
●	Your activity on the Services: Information about your activity on the Services, such as your search queries, comments, domain names, search results selected, number of clicks, pages viewed and the order of those pages, how long you visited our Services, the date and time you used the Services, error logs, and other similar information.<br />
●	Applications: If you use the MYFOJO application, MYFOJO may collect information about the presence and/ or absence and/ or details pertaining to other applications on your mobile phone. The applications we gather information for, may vary across categories including, without limitation, shopping, fashion, food and travel. This will help us understand you and your preferences better and enable MYFOJO to provide you with a personalized experience.<br />
●	Mobile status: For mobile application users, the online or offline status of your application.<br />
</p><br />
<h1 className="font-lato font-bold text-center text-2xl mb-4">Cookies and Other Electronic Tools</h1>
<p>
We, and third parties with whom we partner, may use cookies, pixel tags, web beacons, mobile device IDs, "flash cookies" and similar files or technologies to collect and store information in respect to your use of the Services and third party websites. A cookie is a small text file that is stored on your computer that enables us to recognize you (for example, as a registered user) when you visit our website, store your preferences and settings, enhance your experience by delivering content and advertising specific to your interests, perform research and analytics, track your use of our Services, and assist with security and administrative functions. Cookies may be persistent or stored only during an individual session. A pixel tag (also called a web beacon or clear GIF) is a tiny graphic with a unique identifier, embedded invisibly on a webpage (or an online ad or email), and is used to count or track things like activity on a webpage or ad impressions or clicks, as well as to access cookies stored on users' computers. MYFOJO uses pixel tags to measure the popularity of our various pages, features and services. We also may include web beacons in e-mail messages or newsletters to determine whether the message has been opened and for other analytics.
Most browsers are set to automatically allow cookies. Please note it may be possible to disable some (but not all) cookies through your device or browser settings, but doing so may interfere with certain functionality on the Services. Major browsers provide users with various options when it comes to cookies. Users can usually set their browsers to block all third-party cookies (which are those set by third-party companies collecting information on websites operated by other companies), block all cookies (including first-party cookies such as the ones MYFOJO uses to collect search activity information about its users), or block specific cookies. To modify your cookie settings, please visit your browser's help settings. You will need to opt out on each browser and each device you use to access the Services. Flash cookies operate differently than browser cookies and cannot be removed or blocked via web browser settings. By using our Services with your browser set to accept cookies you are consenting to our use of cookies in the manner described in this section.
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">Precise Location Information and How to Opt Out</h1>
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">Anonymous or De-Identified Data</h1>
<p>
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">How we use the information we collect</h1>
<p>
●	We use the information we collect from and about you for a variety of purposes, including to:<br />
●	Process and respond to your queries<br />
●	Understand our users (what they do on our Services, what features they like, how they use them, etc.), improve the content and features of our Services (such as by personalizing content to your interests), process and complete your transactions, and make special offers.<br />
●	Generate and review reports and data about, and to conduct research on, our user base and Service usage patterns.<br />
●	Administer contests and sweepstakes.<br />
●	Provide you with customer support.<br />
●	Provide you with policies about your account.<br />
...
●	Allow you to participate in interactive features offered through our Services.<br />
●	In any other way we may describe when you provide the information.<br />
●	For any other purpose with your consent.<br />
●	Administer our Services and diagnose technical problems.<br />
●	Send you communications that you have requested or that may be of interest to you by way of emails, or courier, or registered post, or telephone calls, or any other mode of communication. We may also share your preferences or the Services availed by you with your network followers on MYFOJO for marketing and other promotional activities of our Services.<br />
●	Send you questions from other users that you may be able to answer if you have registered with MYFOJO.<br />
●	Enable us to show you ads that are relevant to you.<br />
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">How we share the information we collect</h1>
<p>
...
<b>General Information Disclosures</b><br />
●	To our subsidiaries and affiliates, which are entities under common ownership or control of our ultimate parent company Foomill Private Limited.<br/>
...
●	If we believe disclosure is necessary or appropriate to protect the rights, property, or safety of MYFOJO, our customers or others. This includes exchanging information with other companies and organizations for the purposes of fraud protection and credit risk reduction.<br/>
●	Consent. We may share your information in any other circumstances where we have your consent.<br/>
●	To a buyer or other successor in the event of a merger, divestiture, restructuring, reorganization, dissolution or other sale or transfer of some or all of MYFOJO assets, whether as a going concern or as part of bankruptcy, liquidation or similar proceeding, in which personal information held by MYFOJO about the users of our Services are among the assets transferred.<br />
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">Information Shared with Restaurants</h1>
<p>
When you make a restaurant reservation or execute online food ordering transaction through our Services, your information is provided to us and to the restaurants with whom you choose to reserve. In order to facilitate your reservation and online food order processing, we provide your information to that restaurant in a similar manner as if you had made a reservation or food order directly with the restaurant. If you provide a mobile phone number, restaurants or MYFOJO may send you text messages regarding your reservation or order's delivery status. Some restaurants also require you to provide credit or debit card account information to secure your reservation. When you make a restaurant reservation or online food ordering transaction through our Services and/or make a payment to a restaurant through our Services, we may also share with the restaurants additional information, such as information about your dining preferences and history or information that we collect from third-parties.
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">Communication choices</h1>
<p>
  When you sign up for an account, you are opting in to receive emails from other MYFOJO users, businesses, and MYFOJO itself. You can log in to manage your email preferences and follow the "unsubscribe" instructions in commercial email messages, but note that you cannot opt out of receiving certain administrative policy, service policy, or legal policy from MYFOJO.
  </p><br />
<h1 className="font-lato font-bold text-center text-2xl mb-4">Analytics and tailored advertising</h1>
<p>
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">Tailored Advertising</h1>
<p>
  Third parties whose products or services are accessible or advertised via the Services may also use cookies or similar technologies to collect information about your use of the Services. This is done in order to help them-<br/>
●	Inform, optimize, and serve ads based on past visits to our website and other sites and<br />
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">Choices about how we use and disclose your information</h1>
<p>
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">Reviewing, changing or deleting information</h1>
<p>
If you would like to review, change or delete personal information we have collected from you, or permanently delete your account, please use the "Contact Us" link at the bottom of every page (also located here), or contact the MYFOJO Data Protection Officer (DPO).
If you delete your User Contributions from our websites, copies of your User Contributions may remain viewable in cached and archived pages, or might have been copied or stored by other users of our websites. Proper access and use of information provided on our websites, including User Contributions, is governed by our terms and use.
</p><br />
<h1 className="font-lato font-bold text-center text-2xl mb-4">Accessing & correcting your personal information</h1>
<p>
...
Your right to review, update, correct, and delete your personal information may be limited, subject to the law of your jurisdiction:<br/>
●	If your requests are abusive or unreasonably excessive,<br />
●	Where the rights or safety of another person or persons would be encroached upon, or<br />
...
<h1 className="font-lato font-bold text-center text-2xl mb-4">Security: How we protect your information</h1>
<p>
...
We assume no liability or responsibility for disclosure of your information due to errors in transmission, unauthorized third-party access, or other causes beyond our control. You play an important role in keeping your personal information secure. You should not share your user name, password, or other security information for your MYFOJO account with anyone. If we receive instructions using your user name and password, we will consider that you have authorized the instructions.
</p><br />
<h1 className="font-lato font-bold text-center text-2xl mb-4">California privacy rights</h1>
<p>
California law permits users who are California residents to request and obtain from us once a year, free of charge, a list of the third parties to whom we have disclosed their personal information (if any) for their direct marketing purposes in the prior calendar year, as well as the type of personal information disclosed to those parties. To make such a request, please contact us at the information provided in <b>CONTACT US</b> section.
</p><br />
<h1 className="font-lato font-bold text-center text-2xl mb-4">Permissible Age</h1>
<p>
The Services are not intended for users under the age of 18, unless permitted under applicable local laws (Permissible Age). We do not knowingly collect any personal information from users or market to or solicit information from anyone under the Permissible Age. If we become aware that a person submitting personal information is under the Permissible Age, we will delete the account and any related information as soon as possible. If you believe we might have any information from or about a user under the Permissible Age, please contact us at contactus@myfojo.com
</p><br />
<h1 className="font-lato font-bold text-center text-2xl mb-4"> Payment Card Information</h1>
<p>
...
●	When you use a credit or debit card to secure a reservation through our Sites, we provide your credit or debit card account information (including card number and expiration date) to our third-party payment service providers and the applicable restaurant.<br />
●	When you initially provide your credit or debit card account information through our Services in order to use our restaurant payment services, we provide your credit or debit card account information to our third-party payment service providers. As explained in our Terms of Use, these third parties may store your credit or debit card account information so you can use our restaurant payment services through our Services in the future.<br />
●	For information about the security of your credit or debit card account information, see the "Security" section below.<br/>
</p><br />

<h1 className="font-bold text-center text-2xl mb-4">Third party services</h1>
<p>
The Services may contain links to third-party websites. Your use of these features may result in the collection, processing or sharing of information about you, depending on the feature. Please be aware that we are not responsible for the content or privacy practices of other websites or services which may be linked on our services. We do not endorse or make any representations about third-party websites or services. Our Privacy Policy does not cover the information you choose to provide to or that is collected by these third parties. We strongly encourage you to read such third parties' privacy policies.</p><br />

 <h1 className="font-lato font-bold text-center text-2xl mb-4">EU privacy/data protection rights</h1>
 <p>
EU General Data Protection Regulation (GDPR) has provided the below rights to the EU residents:<br />
●	<b>Right to information</b> - including contact details to the DPO, the purposes for processing Personal Information and the rights of the individual.
●	<b>Right to access the Personal Information that are processed</b> <br />
●	<b>Right to erasure</b> (”Right to be forgotten”)<br />
●	<b>Right to rectification<br />
●	Right to restriction of processing</b> <br />
●	<b>Right to data portability </b>of the Personal Information supplied to MYFOJO by the EU resident<br />
●	<b>Right to object</b> (opt-out) to processing (unless MYFOJO otherwise has compelling legitimate grounds)<br />
EU residents can exercise these rights by raising a request directly at contactus@myfojo.com or contact us at the information provided in CONTACT US section.
</p>
<h1 className="font-bold text-center text-2xl mb-4">Data retention and account termination</h1>
 <p>
...
<h1 className="font-bold text-center text-2xl mb-4">Contact us</h1>
  <p>If you have any queries relating to the processing/ usage of information provided by you or MYFOJO Privacy Policy, you may email the Data Protection Officer (DPO) at contactus@myfojo.com or write to us at the following address.</p><br />
<br />
<h1 className="font-bold text-center text-2xl mb-4">For Users residing in any other part of the world:</h1>
 <p>Foomill Private Limited (MYFOJO)<br />
1350, Sector-28, Faridabad - 121008, Haryana, India
</p>
